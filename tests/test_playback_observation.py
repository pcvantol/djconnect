...
class PlaybackObservationTest(unittest.TestCase):
    ...
    def test_rolling_records_reconcile_pr_300_before_next_production_capability(self) -> None:
        for name in (
            ...
            self.assertIn("PR [#300]", contents)
            self.assertIn("822468e10527aa07895a802c99fbcde7eeccd98c", contents)
