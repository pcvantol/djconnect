...
class PlaybackObservationTest(unittest.TestCase):
    ...
    def test_rolling_records_reconcile_pr_274_before_next_production_slice(self) -> None:
        for name in (
            ...
            self.assertIn("PR [#274]", contents)
            self.assertIn("2e359f218dc590fa418224dec78d201a2941f158", contents)
