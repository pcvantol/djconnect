...
class PlaybackObservationTest(unittest.TestCase):
    ...
    def test_rolling_records_reconcile_pr_272_before_next_production_slice(self) -> None:
        for name in (
            ...
            self.assertIn("PR [#272]", contents)
            self.assertIn("97b748b6858b021b08423e6d661e02904e55a4b1", contents)
