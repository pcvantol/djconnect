...
class ServicesYamlTest(unittest.TestCase):
    def test_developer_actions_are_documented(self) -> None:
        ...
        self.assertIn("SI-GOLDEN-004", text)
        self.assertIn("SI-GOLDEN-005", text)
        self.assertIn("SI-GOLDEN-006", text)
        ...
        self.assertIn("Capture Session Intelligence Golden Scenario", text)
        self.assertIn("Run Golden Qualification Foundation", text)
        self.assertIn("does not test a Renderer Host", text)
