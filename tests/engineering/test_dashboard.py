...
class DashboardStatusTest(unittest.TestCase):
    ...
    def test_dashboard_uses_server_push_without_browser_status_polling(self) -> None:
        ...
        self.assertIn('.markdown-copy-wrap .markdown-document,.markdown-copy-wrap>#reportContent,.markdown-copy-wrap>#reportAnalysisContent{padding-right:68px}', page)
        self.assertIn('position:absolute;right:14px;top:10px', page)
