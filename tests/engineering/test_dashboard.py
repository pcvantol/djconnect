...
class DashboardStatusTest(unittest.TestCase):
    ...
    def test_dashboard_uses_server_push_without_browser_status_polling(self) -> None:
        ...
        self.assertIn('<details class="last-execution last-execution-group" id="lastExecutionGroup"', page)
        ...
        self.assertIn('<summary><h2 class="last-execution-group__heading"', page)
        ...
        self.assertIn('.workspace-card{margin-bottom:16px}.dashboard-grid{gap:16px}.dashboard-grid>#componentLogs,.dashboard-grid>#codexChat,.dashboard-grid>.technical-details:not(#componentLogs){margin-top:0}', page)
