...
class ExecutionLifecycleProjectionTests(unittest.TestCase):
    ...
    def test_status_reconciliation_uses_its_own_merge_path(self) -> None:
        ...
        self.assertEqual(
            path,
            ("START", "INITIALIZE", "CAPABILITY_REVIEW", "EXECUTE_AGENT", "REPAIR_AGENT", "WAIT_FOR_OPERATOR_MERGE", "FINALIZE_AGENT", "WAIT_FOR_FINALIZATION_MERGE", "RECONCILE_AGENT", "REPOSITORY_CLEANUP", "TERMINAL"),
        )
