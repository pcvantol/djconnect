...
| V4-01 Server-owned Active DJ Session Runtime | Completed / reviewable frozen | Create, look up and destroy one ephemeral Runtime per resolved Profile, exposing only the paired Apple-client start, active lookup and end lifecycle. | `codex/v4-active-session-runtime` | Explicit implementation prompt authorized 2026-07-20; PR [#216](https://github.com/pcvantol/djconnect/pull/216). |
