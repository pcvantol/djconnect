...
| 15 | Platform Test Coverage Improvement | Future | To be generated by future operator prompt | Coverage Baseline 1 established; Windows Coverage Baseline 1 established; Phase 14 returns `CROSS_PLATFORM_QUALIFIED` | Future coverage improvement reports, normalized coverage evidence and trend analysis versus Coverage Baseline 1 plus the Windows starting point | Future PRs; preserve Coverage Baseline 1 immutable | Platform Baseline v1.0 Certification |
