...
- Home Assistant integration: `3.2.4`
- Domain: `djconnect`
...
```json
{
  ...
  "version_tag": "v3.2.4",
  "channel": "stable",
  "min_ha_integration": "3.2.4",
  "firmwares": [
    {
      "board": "t_embed_cc1101",
      "device": "lilygo-t-embed-s3",
      "asset": "djconnect-lilygo-t-embed-s3-v3.2.4.bin",
      "url": "https://github.com/pcvantol/djconnect-firmware/releases/download/v3.2.4/djconnect-lilygo-t-embed-s3-v3.2.4.bin",
    ...
    },
    {
      ...
      "asset": "djconnect-esp32-s3-box-3-v3.2.4.bin",
      "url": "https://github.com/pcvantol/djconnect-firmware/releases/download/v3.2.4/djconnect-esp32-s3-box-3-v3.2.4.bin",
...
```bash
./release.sh 3.2.4 --publish-firmware-repo ../djconnect-firmware
```
...
```bash
git add .
git commit -m "Release DJConnect v3.2.4"
git tag v3.2.4
git push origin main
git push origin v3.2.4
gh release create v3.2.4 --title "DJConnect v3.2.4" --notes-file CHANGELOG.md
```
