...
- Home Assistant integration: `3.2.13`
- Domain: `djconnect`
...
```json
{
  ...
  "version_tag": "v3.2.13",
  "channel": "stable",
  "min_ha_integration": "3.2.13",
  "firmwares": [
    {
      "board": "t_embed_cc1101",
      "device": "lilygo-t-embed-s3",
      "asset": "djconnect-lilygo-t-embed-s3-v3.2.13.bin",
      "url": "https://github.com/pcvantol/djconnect-firmware/releases/download/v3.2.13/djconnect-lilygo-t-embed-s3-v3.2.13.bin",
...
```bash
./release.sh 3.2.13 --publish-firmware-repo ../djconnect-firmware
```
...
```bash
git add .
git commit -m "Release DJConnect v3.2.13"
git tag v3.2.13
git push origin main
git push origin v3.2.13
gh release create v3.2.13 --title "DJConnect v3.2.13" --notes-file CHANGELOG.md
```
