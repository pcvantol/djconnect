...
Ask DJ can answer recent Spotify listening questions for tracks, albums, artists and playlist contexts with compact artwork/icon lists. The native playback proxy and related Home Assistant entities reflect current Spotify play/pause state, volume, album art, output, repeat, shuffle, queue and playlists when Spotify is authorized.
