...
| Platform Dependency Governance conformance | P1 | Current execution | `docs/software_assurance/PLATFORM_DEPENDENCY_GOVERNANCE_POLICY.md`; GitHub-native Dependabot configuration rollout | GitHub-native version-update conformance only; TDE remains Deferred and no new analyzer or product behavior is authorized |
