...
| GitHub Actions retention and evidence preservation (`TD-GITHUB-001`) | P1 | Completed | PR #543 / `docs/software_assurance/TD_GITHUB_001_RETENTION_EVIDENCE_ASSESSMENT.md`; current Actions cleanup, release and qualification evidence contracts | `GO_TD_GITHUB_001_PARTIALLY_QUALIFIED`; Evidence Preservation Qualification remains Future Assessment only, with no retention/archive implementation authorization |
