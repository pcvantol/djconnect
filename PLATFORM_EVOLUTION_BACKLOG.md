...
| Component Release Mode | P2 | Assessed | `docs/release/COMPONENT_RELEASE_MODE_ASSESSMENT.md`, `docs/release/COMPONENT_RELEASE_QUALIFICATION_ASSESSMENT.md` and `docs/release/COMPONENT_RELEASE_SCOPE_REFINEMENT.md` | `GO_COMPONENT_RELEASE_SCOPE_REFINEMENT_PARTIALLY_QUALIFIED`; canonical profiles exist for HACS, API, website, ESP32, iOS/watchOS, macOS, Windows and the shared Pi family. The next bounded work is Runtime selection/evidence closure implementation; no component execution or release is authorized. |
