...
| Platform Dependency Governance conformance | P1 | Assessed | `docs/software_assurance/PLATFORM_DEPENDENCY_GOVERNANCE_CONFORMANCE_ASSESSMENT.md`; active repository inventory | `NO_GO_PLATFORM_DEPENDENCY_GOVERNANCE_DIVERGENCE`; no canonical version-update, Dependency Review, ecosystem-audit or active TDE evidence contract is established |
