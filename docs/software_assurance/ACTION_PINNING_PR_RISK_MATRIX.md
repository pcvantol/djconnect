...
| --- | --- | --- | --- | --- | --- |
| `djconnect` [#78](https://github.com/pcvantol/djconnect/pull/78) | Six CI/release workflow action SHA pins; Batch 1–4 registry and migration evidence; removal of superseded non-canonical Prompt 3 copy. | `NORMAL_RISK` | No control-policy semantic change; action pin/evidence scope only. | canonical validation, CodeQL, Semgrep, Verification and qualification | No | Yes after all required checks and qualification pass. |
