...
Assistant user hint, Voice Endpoint such as a Home Assistant Voice Satellite, HA device/entity,
...
- Shared Voice Endpoints should normally resolve through explicit Voice
  Endpoint, room/area or fallback mappings.
