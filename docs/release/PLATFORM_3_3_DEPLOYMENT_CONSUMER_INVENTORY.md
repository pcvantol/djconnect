...
7. Apple and Windows static deployment/smoke entrypoints exist, but no artifact
   provenance, signing/install or target-health scope is configured.
8. The historical execution-workflow matrix overstated rollout coverage. It
