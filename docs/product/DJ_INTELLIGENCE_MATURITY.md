...
| --- | --- | --- |
| PL-3.2 — audience-direction consensus | Deferred — superseded by the Audience Experience boundary | Individual Audience Events and Audience Projections never enter the Planner. Any future Planner consideration requires a separately approved, coarse, privacy-preserving Audience Observation with explicit aggregation, confidence, ownership and artistic-autonomy evidence; no Planner integration is authorized. |
