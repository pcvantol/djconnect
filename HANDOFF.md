...
- Current integration release: `3.2.41`.
- Release status: DJConnect `3.2.41` keeps the `3.2.x` transport, pairing and
...
- Current latest baseline is `3.2.41`.
...
- For the current `3.2.41` release, no pinned Python package versions were
