...
- Current integration release: `3.2.27`.
- Release status: DJConnect `3.2.27` keeps the `3.2.x` transport, pairing and
...
- Current latest baseline is `3.2.27`.
...
- For the current `3.2.27` release, no pinned Python package versions were
  upgraded. The current release refreshes release context and restores the
  missing `3.2.26` changelog notes while keeping backend commands and Ask DJ
  routes intact.
