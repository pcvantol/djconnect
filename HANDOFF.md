...
- Current integration release: `3.2.40`.
- Release status: DJConnect `3.2.40` keeps the `3.2.x` transport, pairing and
...
- Current latest baseline is `3.2.40`.
...
- For the current `3.2.40` release, no pinned Python package versions were
