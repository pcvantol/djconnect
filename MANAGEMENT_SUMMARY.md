...
| V4-03 Broadcast Engine Foundation | In progress; bounded implementation of one ephemeral Broadcast Engine and canonical empty Broadcast State per active Runtime | `codex/v4-broadcast-engine-foundation`; `DJ_SESSION_RUNTIME_CONTRACTS.md` |
