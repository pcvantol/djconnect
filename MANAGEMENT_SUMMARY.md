...
| V4-01 Active Session Runtime | Reviewable implementation slice: one server-owned ephemeral Runtime per Profile with paired Apple-client lifecycle only | PR [#216](https://github.com/pcvantol/djconnect/pull/216); `PRODUCT_ROADMAP.md`; `DJ_SESSION_RUNTIME_CONTRACTS.md` |
