...
| DJConnect v4 Architecture | Reviewable documentation-only Architecture Review: canonical convergence around Profile, DJ Session Runtime, Session Planner/Flow and VibeCast Broadcast Capability | PR [#212](https://github.com/pcvantol/djconnect/pull/212); `DJCONNECT_V4_ARCHITECTURE.md` |
