...
| V4-02 Session Planner Foundation | In progress; bounded implementation of one ephemeral Planner per active Runtime, without AI planning or Session Flow generation | `codex/v4-session-planner-foundation`; `DJ_SESSION_RUNTIME_CONTRACTS.md` |
