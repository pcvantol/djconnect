...
| V4-04 Canonical Session Flow | In progress; bounded implementation of one deterministic Planner-owned Session Flow per active Runtime, distributed through Broadcast | `codex/v4-canonical-session-flow`; `DJ_SESSION_RUNTIME_CONTRACTS.md` |
