...
| CMB-05 — Pi 4-inch capability profile | Planned | No Pi 4-inch profile decision is recorded. | Current Pi source; contract; shared-device privacy evidence. | Execution Horizon | Platform Evolution | Current Execution Horizon selection. |
| CMB-06 — Pi 10-inch capability profile | Planned | No Pi 10-inch profile decision is recorded. | Hardware; privacy; renderer evidence. | Execution Horizon | Platform Evolution | Current Execution Horizon selection. |
| CMB-07 — Apple–Windows atomic convergence | Planned | No per-capability convergence disposition is recorded. | Contract-level supported/absent matrix. | Execution Horizon | Platform Evolution | Current Execution Horizon selection. |
