...
DESIRED_ENGINEERING_PLATFORM_VERSION=''
DESIRED_ENGINEERING_WATCHER_LAUNCH_AGENT=''
DESIRED_ENGINEERING_DASHBOARD_LAUNCH_AGENT=''
DESIRED_ENGINEERING_DASHBOARD_HEALTH_URL=''
DESIRED_ENGINEERING_STATUS_RELATIVE_PATH=''
DESIRED_ENGINEERING_REPORTS_RELATIVE_PATH=''
...
readonly REPAIR_PROGRESS_TOTAL=7
ALLOW_STEP_RETRY=1
