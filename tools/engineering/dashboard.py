...
.markdown-copy-wrap{position:relative}.markdown-copy-wrap .markdown-document,.markdown-copy-wrap>#reportContent,.markdown-copy-wrap>#reportAnalysisContent{padding-right:68px}.copy.copy--glyph{align-items:center;background:#24242de6;border-color:var(--category-color);border-radius:50%;box-shadow:0 2px 8px #0008;display:flex;float:none;font-size:0;height:32px;justify-content:center;min-height:32px;min-width:32px;padding:0;position:absolute;right:14px;top:10px;width:32px;z-index:2}.copy.copy--glyph::before{content:"⧉";font:20px/1 system-ui}.copy.copy--glyph:hover{background:#353541}.copy.copy--glyph:focus-visible{outline-color:var(--category-color)}
...
<header class="dashboard-titlebar"><div class="dashboard-titlebar__brand"><img class="dashboard-app-icon" src="/assets/engineering-status-icon.svg" alt="" aria-hidden="true" data-testid="dashboard-app-icon"><h1>$TITLE</h1></div><div class="dashboard-titlebar__actions"><button class="section-state-toggle" id="toggleAllSections" type="button" role="switch" aria-checked="false" aria-label="Alle secties openen" data-testid="toggle-all-sections"><span class="section-state-toggle__label">Alles</span></button><label class="auto-refresh-toggle" for="autoRefresh"><input id="autoRefresh" type="checkbox" checked><span>Automatisch vernieuwen</span></label></div></header>
