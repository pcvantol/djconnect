...
#componentLogs{background:#302a24;border-left:3px solid #f0b66a}#componentLogs .card{background:#24242d;border-left:0}main>details.technical-details:not(#componentLogs){background:#28263a;border-left:3px solid #a78bfa}main>details.technical-details:not(#componentLogs) .card{background:#24242d;border-left:0}
</style>
<h1>$TITLE</h1>
