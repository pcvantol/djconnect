...
pre{white-space:pre-wrap;word-break:break-word;margin:5px 0 0;font:12px ui-monospace,monospace}.log-controls{align-items:end;display:flex;flex-wrap:wrap;gap:8px;margin:12px 0}.log-controls label{color:#c7a6ff;display:grid;font-size:11px;font-weight:700;gap:3px;letter-spacing:.04em;text-transform:uppercase}.log-controls input,.log-controls select{background:#18181f;border:1px solid #57576a;border-radius:7px;color:#f7f3ee;font:13px system-ui;padding:6px}.log-controls input{min-width:190px}.log-table-wrap{max-height:420px;overflow:auto;border:1px solid #3d3651;border-radius:9px;margin-top:10px}.log-table{border-collapse:collapse;font:12px ui-monospace,monospace;min-width:780px;width:100%;user-select:text}.log-table th{background:#2d2d38;color:#c7a6ff;position:sticky;text-align:left;top:0;z-index:1}.log-table th,.log-table td{border-bottom:1px solid #3d3651;padding:7px 8px;vertical-align:top}.log-table td{white-space:pre-wrap;word-break:break-word}.log-table tr:last-child td{border-bottom:0}.log-line-number{color:#92919b;text-align:right;width:1%;user-select:none}.log-level{font-weight:700}.log-level--error{color:#ff8585}.log-level--warning{color:#f4d35e}.log-level--info{color:#8dc7ff}.log-level--debug{color:#b9b6c0}.log-empty{color:#b9b6c0;padding:10px}[hidden]{display:none}
</style>
<h1>$TITLE</h1>
...
<section class="card codex-chat" id="codexChat"><strong>Codex gesprek</strong><p class="estimate-meta">Alleen lezen · context: repository, laatst uitgevoerde prompt en rapport. Deze chat kan geen engineering starten of wijzigingen uitvoeren.</p><p class="field"><span class="label">Gebruikt model</span><span id="chatModel">$CHAT_MODEL</span></p><div class="chat-messages" id="chatMessages" aria-live="polite" aria-label="Gesprek met Codex"></div><label class="label" for="chatInput">Nieuwe vraag aan Codex</label><textarea id="chatInput" class="chat-input" rows="5" maxlength="2000" placeholder="Bijvoorbeeld: wat zijn de belangrijkste vervolgstappen uit het laatste rapport?"></textarea><p><button class="chat-send" id="chatSend" type="button">Verstuur vraag</button> <span class="chat-status" id="chatStatus"></span></p></section>
