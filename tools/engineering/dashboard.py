...
<div class="card"><strong>Host Preflight</strong><p class="field"><span class="label">Execution Host</span><span id="executionHostName">Niet beschikbaar</span></p><p class="field"><span class="label">Execution Host Version</span><span id="executionHostVersion">Niet beschikbaar</span></p><p class="field"><span class="label">Runtime</span><span id="executionHostRuntime">Niet beschikbaar</span></p><p class="field"><span class="label">Runtime Prompt Transport</span><span id="executionHostTransport">Niet beschikbaar</span></p><p class="field"><span class="label">Hoststatus</span><span id="hostPreflightStatus">Niet beschikbaar</span></p><p class="field"><span class="label">Workspacestatus</span><span id="workspacePreflightStatus">Niet beschikbaar</span></p><p class="field"><span class="label">Capabilitystatus</span><span id="capabilityPreflightStatus">Niet beschikbaar</span></p><p class="field"><span class="label">Herstelbaarheid</span><span id="capabilityRecoverability">Niet beschikbaar</span></p><p class="field"><span class="label">Failure Origin</span><span id="capabilityFailureOrigin">Niet beschikbaar</span></p><p class="field"><span class="label">Aanbevolen actie</span><span id="capabilityRecommendation">Niet beschikbaar</span></p></div>
