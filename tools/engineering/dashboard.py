...
#componentLogs{background:#302a24;border-left:3px solid #f0b66a}#componentLogs .card{background:#24242d;border-left:0}main>details.technical-details:not(#componentLogs){background:#28263a;border-left:3px solid #a78bfa}main>details.technical-details:not(#componentLogs) .card{background:#24242d;border-left:0}.last-execution-card{cursor:default}.last-execution-card summary{cursor:pointer;list-style:none}.last-execution-card summary::-webkit-details-marker{display:none}.last-execution-card summary::before{content:"▸ ";color:#8dc7ff}.last-execution-card[open] summary::before{content:"▾ "}.last-execution-card__details{border-top:1px solid #37506a;margin-top:10px;padding-top:2px}
</style>
<h1>$TITLE</h1>
