...
from .codex_chat import CodexChatError, respond as codex_chat_response
    ...
    class DashboardHandler(BaseHTTPRequestHandler):
        ...
        def do_POST(self) -> None:
            ...
            try:
                ...
                return
            self._send(json.dumps({"answer": answer}, ensure_ascii=False).encode(), "application/json; charset=utf-8")
