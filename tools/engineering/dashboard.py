...
<header class="dashboard-titlebar"><h1>$TITLE</h1><label class="auto-refresh-toggle" for="autoRefresh"><input id="autoRefresh" type="checkbox" checked><span>Automatisch vernieuwen</span></label></header>
...
<section class="card card--context" id="queueItems" data-testid="engineering-inbox-queue"><strong>Inbox-wachtrij</strong><p class="estimate-meta" id="queueSummary">Wachtrij laden…</p><ol class="queue-list" id="queueList" aria-live="polite"></ol></section>
