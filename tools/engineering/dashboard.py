...
<div class="card"><strong data-i18n="detail.execution"></strong><p class="field"><span class="label" data-i18n="detail.run_id"></span><span id="runId"></span></p><p class="field"><span class="label" data-i18n="ui.prompt_started"></span><span id="promptStarted" data-i18n="format.loading"></span></p><p class="field"><span class="label" data-i18n="section.inbox_queue"></span><span id="queue"></span></p></div>
...
<dialog class="component-modal" id="componentModal" aria-labelledby="componentModalTitle"><section class="component-modal__panel"><button class="component-modal__close" id="componentModalClose" type="button" data-i18n-aria-label="sections.close">×</button><h2 id="componentModalTitle" data-i18n="ui.component_information"></h2><div id="componentModalContent"></div><button class="component-modal__restart" id="componentModalRestart" type="button" hidden data-i18n="ui.component_restart"></button><p class="component-modal__status" id="componentModalStatus" aria-live="polite"></p></section></dialog>
<dialog class="confirmation-modal" id="confirmationModal" aria-labelledby="confirmationModalTitle"><section class="confirmation-modal__panel"><h2 id="confirmationModalTitle" data-i18n="ui.confirm_action"></h2><p id="confirmationModalText"></p><div class="confirmation-modal__actions"><button id="confirmationModalCancel" type="button" data-i18n="action.cancel"></button><button id="confirmationModalConfirm" type="button" data-i18n="action.confirm"></button></div></section></dialog>
<dialog class="report-view-modal" id="promptHistoryReportModal" aria-labelledby="promptHistoryReportModalTitle"><section class="report-view-modal__panel"><header class="report-view-modal__header"><h2 class="report-view-modal__title" id="promptHistoryReportModalTitle" data-i18n="history.report_title"></h2><div class="report-view-modal__actions"><button class="download download--glyph" id="promptHistoryReportDownload" type="button" hidden>⇩</button><button class="copy copy--glyph" id="promptHistoryReportCopy" type="button" hidden>⧉</button><button class="report-view-modal__close" id="promptHistoryReportClose" type="button" data-i18n-aria-label="sections.close">×</button></div></header><article class="markdown-document report-view-modal__content" id="promptHistoryReportContent" data-i18n="history.report_loading"></article></section></dialog>
<dialog class="prompt-detail-modal" id="promptHistoryDetailModal" aria-labelledby="promptHistoryDetailTitle"><section class="prompt-detail-modal__panel"><header class="prompt-detail-modal__header"><h2 id="promptHistoryDetailTitle" data-i18n="history.details_loading"></h2><button class="report-view-modal__close" id="promptHistoryDetailClose" type="button" data-i18n-aria-label="sections.close">×</button></header><p class="prompt-detail-modal__description" id="promptHistoryDetailDescription"></p><div class="prompt-detail-modal__content" id="promptHistoryDetailContent" data-i18n="history.details_loading"></div></section></dialog>
<dialog class="prompt-chat-modal" id="promptHistoryChatModal" aria-labelledby="promptHistoryChatTitle"><section class="prompt-chat-modal__panel"><header class="prompt-chat-modal__header"><h2 id="promptHistoryChatTitle" data-i18n="section.ai_conversation"></h2><button class="report-view-modal__close" id="promptHistoryChatClose" type="button" data-i18n-aria-label="sections.close">×</button></header><p class="prompt-chat-modal__description" id="promptHistoryChatDescription"></p><section class="codex-chat" id="codexChat"><div class="codex-chat__details"><div class="chat-actions"><button class="download download--glyph" id="downloadChat" type="button" hidden>⇩</button><button class="clear-chat" id="clearChat" type="button" hidden>⌫</button></div><div class="chat-messages" id="chatMessages" aria-live="polite" data-i18n-aria-label="section.ai_conversation"></div><label class="label" for="chatInput" data-i18n="section.new_ai_question"></label><p class="chat-status" id="chatStatus"></p><div class="chat-compose"><textarea id="chatInput" class="chat-input" rows="5" maxlength="2000" autocomplete="off" data-sanitize="multiline" data-i18n-placeholder="history.chat_placeholder"></textarea><button class="chat-send" id="chatSend" type="button" data-i18n-aria-label="action.confirm"><span aria-hidden="true">➤</span></button></div><p class="field"><span class="label" data-i18n="detail.model"></span><span id="chatModel">$CHAT_MODEL</span></p></div></section></section></dialog>
...
<div class="card"><strong id="technicalPullRequestsTitle">Pull requests</strong><p class="field"><span class="label" id="technicalImplementationLabel">Implementatie</span><span id="implementation"></span></p><p class="field"><span class="label" id="technicalFinalizationLabel">Finalisatie</span><span id="finalization"></span></p></div>
<div class="card"><strong id="technicalRepositoryTitle">Repository</strong><p class="field"><span class="label" id="technicalRepositoryStateLabel">Repositorystatus</span><span id="repositoryState"></span></p><p class="field"><span class="label" id="technicalWorkspaceStateLabel">Werkruimtestatus</span><span id="workspaceState"></span></p></div>
<div class="card"><strong id="technicalHostPreflightTitle">Host Preflight</strong><p class="field"><span class="label" id="technicalExecutionHostLabel">Execution Host</span><span id="executionHostName">Niet beschikbaar</span></p><p class="field"><span class="label" id="technicalExecutionHostVersionLabel">Execution Host Version</span><span id="executionHostVersion">Niet beschikbaar</span></p><p class="field"><span class="label" id="technicalRuntimeLabel">Runtime</span><span id="executionHostRuntime">Niet beschikbaar</span></p><p class="field"><span class="label" id="technicalRuntimePromptTransportLabel">Runtime Prompt Transport</span><span id="executionHostTransport">Niet beschikbaar</span></p><p class="field"><span class="label" id="technicalHostStatusLabel">Hoststatus</span><span id="hostPreflightStatus">Niet beschikbaar</span></p><p class="field"><span class="label" id="technicalLastCheckLabel">Laatste controle</span><span id="hostPreflightTimestamp">Niet beschikbaar</span></p><p class="field"><span class="label" id="technicalWorkspacePreflightStatusLabel">Workspacestatus</span><span id="workspacePreflightStatus">Niet beschikbaar</span></p><p class="field"><span class="label" id="technicalLastWorkspaceCheckLabel">Laatste workspacecontrole</span><span id="workspacePreflightTimestamp">Niet beschikbaar</span></p><p class="field"><span class="label" id="technicalCapabilityStatusLabel">Capabilitystatus</span><span id="capabilityPreflightStatus">Niet beschikbaar</span></p><p class="field"><span class="label" id="technicalRecoverabilityLabel">Herstelbaarheid</span><span id="capabilityRecoverability">Niet beschikbaar</span></p><p class="field"><span class="label" id="technicalFailureOriginLabel">Failure Origin</span><span id="capabilityFailureOrigin">Niet beschikbaar</span></p><p class="field"><span class="label" id="technicalRecommendationLabel">Aanbevolen actie</span><span id="capabilityRecommendation">Niet beschikbaar</span></p></div>
<div class="card"><strong id="technicalDiagnosticsTitle">Diagnose</strong><p id="diag"></p></div>
</div></details>
...
<footer class="footer" aria-live="polite"><span class="footer__item"><span class="label" id="platformVersionLabel">Engineering Platform-versie</span><span id="platformVersion">Laden…</span></span><span class="footer__separator" aria-hidden="true">·</span><span class="footer__item" id="lastRefresh">Laatst bijgewerkt: laden…</span><span class="footer__separator" aria-hidden="true">·</span><span class="footer__item" id="updateMode">Serverpush: verbinden…</span></footer><span id="dashboardVersion" hidden></span><span id="workerVersion" hidden></span>
