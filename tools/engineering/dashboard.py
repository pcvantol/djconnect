...
<details class="card codex-chat" id="codexChat"><summary><strong>AI-gesprek</strong></summary><div class="codex-chat__details"><p class="estimate-meta">Alleen lezen · context: repository, laatst uitgevoerde prompt en rapport. Deze chat kan geen engineering starten of wijzigingen uitvoeren.</p><p class="field"><span class="label">Gebruikt model</span><span id="chatModel">$CHAT_MODEL</span></p><div class="chat-messages" id="chatMessages" aria-live="polite" aria-label="Gesprek met AI-assistent"></div><label class="label" for="chatInput">Nieuwe vraag aan AI-assistent</label><textarea id="chatInput" class="chat-input" rows="5" maxlength="2000" placeholder="Bijvoorbeeld: wat zijn de belangrijkste vervolgstappen uit het laatste rapport?"></textarea><p><button class="chat-send" id="chatSend" type="button">Verstuur vraag</button> <span class="chat-status" id="chatStatus"></span></p></div></details>
