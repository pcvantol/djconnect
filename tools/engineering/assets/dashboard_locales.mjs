...
Object.assign(messages.en, {
  "dashboard.title":"Engineering Status", "dashboard.loading":"Loading data…", "dashboard.platform_version":"Engineering Platform {version}",
...
Object.assign(messages.nl, {
  "dashboard.title":"Engineeringstatus", "dashboard.loading":"Gegevens laden…", "dashboard.platform_version":"Engineeringplatform {version}",
...
Object.assign(messages.de, {
  "dashboard.title":"Engineering-Status", "dashboard.loading":"Daten werden geladen…", "dashboard.platform_version":"Engineering-Plattform {version}",
...
Object.assign(messages.fr, {
  "dashboard.title":"État de l’ingénierie", "dashboard.loading":"Chargement des données…", "dashboard.platform_version":"Plateforme d’ingénierie {version}",
...
Object.assign(messages.es, {
  "dashboard.title":"Estado de ingeniería", "dashboard.loading":"Cargando datos…", "dashboard.platform_version":"Plataforma de ingeniería {version}",
...
Object.assign(messages.en, {"detail.execution":"Execution", "detail.prompt_status":"Prompt status", "detail.prompt_title":"Prompt title", "detail.run_id":"Run ID", "detail.executed_at":"Executed at", "detail.execution_mode":"Execution mode", "detail.repository":"Repository", "detail.target_repository":"Target repository", "detail.duration":"Duration", "detail.agent_duration":"Codex CLI execution time", "detail.total_duration":"Total duration", "detail.runtime":"Runtime", "detail.runtime_provider":"Runtime provider", "detail.model":"Model used", "detail.reasoning_profile":"Reasoning profile", "detail.configuration_profile":"Configuration profile", "detail.codex_cli_version":"Codex CLI version", "detail.provider_usage":"AI provider usage", "detail.input_tokens":"Input tokens", "detail.output_tokens":"Output tokens", "detail.total_tokens":"Total tokens", "detail.git_commit":"Git commit", "detail.recorded_evidence":"Recorded evidence", "detail.execution_evidence":"Execution evidence", "detail.evidence":"Evidence", "detail.specialist_review":"Specialist review", "detail.specialist_reviews":"Specialist agent reviews", "detail.capability":"Capability", "detail.completed":"Completed", "detail.accepted_recommendations":"Accepted recommendations", "detail.selected_because":"Selected for", "detail.not_recorded":"Not recorded."});
Object.assign(messages.nl, {"detail.execution":"Uitvoering", "detail.prompt_status":"Promptstatus", "detail.prompt_title":"Prompttitel", "detail.run_id":"Run-ID", "detail.executed_at":"Uitgevoerd op", "detail.execution_mode":"Uitvoeringsmodus", "detail.repository":"Repository", "detail.target_repository":"Doelrepository", "detail.duration":"Doorlooptijd", "detail.agent_duration":"Codex CLI-uitvoeringstijd", "detail.total_duration":"Totale doorlooptijd", "detail.runtime":"Runtime", "detail.runtime_provider":"Runtimeprovider", "detail.model":"Gebruikt model", "detail.reasoning_profile":"Reasoning-profiel", "detail.configuration_profile":"Configuratieprofiel", "detail.codex_cli_version":"Codex CLI-versie", "detail.provider_usage":"AI-providergebruik", "detail.input_tokens":"Invoertokens", "detail.output_tokens":"Uitvoertokens", "detail.total_tokens":"Totaal tokens", "detail.git_commit":"Git-commit", "detail.recorded_evidence":"Vastgelegd bewijs", "detail.execution_evidence":"Uitvoeringsbewijs", "detail.evidence":"Bewijs", "detail.specialist_review":"Specialistische review", "detail.specialist_reviews":"Specialistische agentreviews", "detail.capability":"Capaciteit", "detail.completed":"Uitgevoerd", "detail.accepted_recommendations":"Gebruikte aanbevelingen", "detail.selected_because":"Geselecteerd voor", "detail.not_recorded":"Niet vastgelegd."});
Object.assign(messages.de, {"detail.execution":"Ausführung", "detail.prompt_status":"Promptstatus", "detail.prompt_title":"Prompttitel", "detail.run_id":"Run-ID", "detail.executed_at":"Ausgeführt am", "detail.execution_mode":"Ausführungsmodus", "detail.repository":"Repository", "detail.target_repository":"Ziel-Repository", "detail.duration":"Dauer", "detail.agent_duration":"Codex-CLI-Ausführungszeit", "detail.total_duration":"Gesamtdauer", "detail.runtime":"Laufzeit", "detail.runtime_provider":"Laufzeitanbieter", "detail.model":"Verwendetes Modell", "detail.reasoning_profile":"Reasoning-Profil", "detail.configuration_profile":"Konfigurationsprofil", "detail.codex_cli_version":"Codex-CLI-Version", "detail.provider_usage":"KI-Anbieternutzung", "detail.input_tokens":"Eingabetoken", "detail.output_tokens":"Ausgabetoken", "detail.total_tokens":"Token insgesamt", "detail.git_commit":"Git-Commit", "detail.recorded_evidence":"Erfasster Nachweis", "detail.execution_evidence":"Ausführungsnachweis", "detail.evidence":"Nachweis", "detail.specialist_review":"Spezialistenreview", "detail.specialist_reviews":"Spezialistenreviews", "detail.capability":"Fähigkeit", "detail.completed":"Ausgeführt", "detail.accepted_recommendations":"Verwendete Empfehlungen", "detail.selected_because":"Ausgewählt für", "detail.not_recorded":"Nicht erfasst."});
Object.assign(messages.fr, {"detail.execution":"Exécution", "detail.prompt_status":"État du prompt", "detail.prompt_title":"Titre du prompt", "detail.run_id":"ID d’exécution", "detail.executed_at":"Exécuté le", "detail.execution_mode":"Mode d’exécution", "detail.repository":"Dépôt", "detail.target_repository":"Dépôt cible", "detail.duration":"Durée", "detail.agent_duration":"Durée d’exécution Codex CLI", "detail.total_duration":"Durée totale", "detail.runtime":"Runtime", "detail.runtime_provider":"Fournisseur d’exécution", "detail.model":"Modèle utilisé", "detail.reasoning_profile":"Profil de raisonnement", "detail.configuration_profile":"Profil de configuration", "detail.codex_cli_version":"Version de Codex CLI", "detail.provider_usage":"Utilisation du fournisseur IA", "detail.input_tokens":"Jetons d’entrée", "detail.output_tokens":"Jetons de sortie", "detail.total_tokens":"Total de jetons", "detail.git_commit":"Commit Git", "detail.recorded_evidence":"Preuve enregistrée", "detail.execution_evidence":"Preuve d’exécution", "detail.evidence":"Preuve", "detail.specialist_review":"Revue spécialisée", "detail.specialist_reviews":"Revues des agents spécialisés", "detail.capability":"Capacité", "detail.completed":"Exécuté", "detail.accepted_recommendations":"Recommandations utilisées", "detail.selected_because":"Sélectionné pour", "detail.not_recorded":"Non enregistré."});
Object.assign(messages.es, {"detail.execution":"Ejecución", "detail.prompt_status":"Estado del prompt", "detail.prompt_title":"Título del prompt", "detail.run_id":"ID de ejecución", "detail.executed_at":"Ejecutado el", "detail.execution_mode":"Modo de ejecución", "detail.repository":"Repositorio", "detail.target_repository":"Repositorio de destino", "detail.duration":"Duración", "detail.agent_duration":"Tiempo de ejecución de Codex CLI", "detail.total_duration":"Duración total", "detail.runtime":"Entorno de ejecución", "detail.runtime_provider":"Proveedor de ejecución", "detail.model":"Modelo utilizado", "detail.reasoning_profile":"Perfil de razonamiento", "detail.configuration_profile":"Perfil de configuración", "detail.codex_cli_version":"Versión de Codex CLI", "detail.provider_usage":"Uso del proveedor de IA", "detail.input_tokens":"Tokens de entrada", "detail.output_tokens":"Tokens de salida", "detail.total_tokens":"Total de tokens", "detail.git_commit":"Commit de Git", "detail.recorded_evidence":"Evidencia registrada", "detail.execution_evidence":"Evidencia de ejecución", "detail.evidence":"Evidencia", "detail.specialist_review":"Revisión especializada", "detail.specialist_reviews":"Revisiones de agentes especializados", "detail.capability":"Capacidad", "detail.completed":"Ejecutado", "detail.accepted_recommendations":"Recomendaciones utilizadas", "detail.selected_because":"Seleccionado para", "detail.not_recorded":"No registrado."});
...
Object.assign(messages.en, {
  "telemetry.title":"Execution Host telemetry", "telemetry.description":"Operational trends for the last seven days. Telemetry is not repository evidence.", "telemetry.table_label":"Daily Execution Host telemetry", "telemetry.day":"Day", "telemetry.prompts":"Prompts", "telemetry.average_execution":"Avg. execution", "telemetry.average_total":"Avg. total", "telemetry.average_wait":"Avg. wait time", "telemetry.input":"Input", "telemetry.output":"Output", "telemetry.total":"Total", "telemetry.complete":"Complete", "telemetry.blocked":"Blocked", "telemetry.failed":"Failed", "telemetry.empty":"No completed Execution Host telemetry is available yet.",
  "value.none":"None", "value.no_diagnostics":"No diagnostics",
  "technical.pull_requests":"Pull requests", "technical.implementation":"Implementation", "technical.finalization":"Finalization", "technical.repository":"Repository", "technical.repository_status":"Repository status", "technical.workspace_status":"Workspace status", "technical.host_preflight":"Host preflight", "technical.execution_host":"Execution Host", "technical.execution_host_version":"Execution Host version", "technical.runtime":"Runtime", "technical.runtime_prompt_transport":"Runtime Prompt Transport", "technical.host_status":"Host status", "technical.last_check":"Last check", "technical.last_workspace_check":"Last workspace check", "technical.capability_status":"Capability status", "technical.recoverability":"Recoverability", "technical.failure_origin":"Failure origin", "technical.recommended_action":"Recommended action", "technical.diagnostics":"Diagnostics",
  "section.active_prompt":"Active prompt", "section.inbox_queue":"Inbox queue", "section.prompt_history":"Prompt history", "section.remaining_usage":"Remaining usage", "section.platform_components":"Platform components", "section.technical_details":"Technical details", "section.workspace":"Workspace", "section.logs":"Logs", "section.execution_host_telemetry":"Execution Host telemetry", "section.local_ai_processes":"Local AI processes", "section.ai_provider_usage":"AI provider usage", "section.ai_execution_diagnostics":"AI execution diagnostics", "section.ai_provider_limits":"AI provider limits", "section.ai_conversation":"AI conversation", "section.new_ai_question":"New question for AI assistant", "chat.user":"You", "chat.assistant":"AI assistant",
  "description.active_prompt":"The active engineering prompt, with current progress, execution time and execution context.", "description.inbox_queue":"Prompts are executed in order of creation date.", "description.prompt_history":"All terminal Engineering Platform executions, cached locally in Engineering SQLite storage.", "description.remaining_usage":"Available usage capacity and resets for the active AI provider.", "description.platform_components":"Live health check of the local Engineering Platform components.", "description.technical_details":"Operational details about pull requests, repository, workspace and diagnostics.", "description.workspace":"The active workspace for this project.", "description.logs":"Redacted, rotating logs from the watcher and dashboard. Updated automatically through server push.",
});
Object.assign(messages.nl, {
  "telemetry.title":"Execution Host-telemetrie", "telemetry.description":"Operationele trends van de laatste zeven dagen. Telemetrie is geen repositorybewijs.", "telemetry.table_label":"Dagelijkse Execution Host-telemetrie", "telemetry.day":"Dag", "telemetry.prompts":"Prompts", "telemetry.average_execution":"Gem. uitvoering", "telemetry.average_total":"Gem. totaal", "telemetry.average_wait":"Gem. wachttijd", "telemetry.input":"Input", "telemetry.output":"Output", "telemetry.total":"Totaal", "telemetry.complete":"Voltooid", "telemetry.blocked":"Geblokkeerd", "telemetry.failed":"Mislukt", "telemetry.empty":"Nog geen voltooide Execution Host-telemetrie beschikbaar.",
  "value.none":"geen", "value.no_diagnostics":"Geen diagnose",
  "technical.pull_requests":"Pull requests", "technical.implementation":"Implementatie", "technical.finalization":"Finalisatie", "technical.repository":"Repository", "technical.repository_status":"Repositorystatus", "technical.workspace_status":"Werkruimtestatus", "technical.host_preflight":"Host preflight", "technical.execution_host":"Execution Host", "technical.execution_host_version":"Execution Host-versie", "technical.runtime":"Runtime", "technical.runtime_prompt_transport":"Runtime Prompt Transport", "technical.host_status":"Hoststatus", "technical.last_check":"Laatste controle", "technical.last_workspace_check":"Laatste workspacecontrole", "technical.capability_status":"Capabilitystatus", "technical.recoverability":"Herstelbaarheid", "technical.failure_origin":"Foutbron", "technical.recommended_action":"Aanbevolen actie", "technical.diagnostics":"Diagnose",
  "section.active_prompt":"Actieve prompt", "section.inbox_queue":"Inbox-wachtrij", "section.prompt_history":"Promptgeschiedenis", "section.remaining_usage":"Resterend gebruik", "section.platform_components":"Platformonderdelen", "section.technical_details":"Technische details", "section.workspace":"Werkruimte", "section.logs":"Logs", "section.execution_host_telemetry":"Execution Host-telemetrie", "section.local_ai_processes":"Lokale AI-processen", "section.ai_provider_usage":"AI-providergebruik", "section.ai_execution_diagnostics":"AI-uitvoeringsdiagnose", "section.ai_provider_limits":"AI-providerlimieten", "section.ai_conversation":"AI-gesprek", "section.new_ai_question":"Nieuwe vraag aan AI-assistent", "chat.user":"Jij", "chat.assistant":"AI-assistent",
  "description.active_prompt":"De actieve engineeringprompt, met actuele voortgang, uitvoeringstijd en uitvoeringscontext.", "description.inbox_queue":"Prompts worden uitgevoerd op volgorde van aanmaakdatum.", "description.prompt_history":"Alle terminale Engineering Platform-uitvoeringen, lokaal gecachet in de Engineering SQLite-opslag.", "description.remaining_usage":"Beschikbare gebruiksruimte en resets van de actieve AI-provider.", "description.platform_components":"Live gezondheidscontrole van de lokale Engineering Platform-componenten.", "description.technical_details":"Operationele details over pull requests, repository, werkruimte en diagnose.", "description.workspace":"De actieve werkruimte van dit project.", "description.logs":"Geredigeerde, roterende logs van watcher en dashboard. Automatisch bijgewerkt via serverpush.",
});
Object.assign(messages.de, {
  "telemetry.title":"Execution-Host-Telemetrie", "telemetry.description":"Betriebstrends der letzten sieben Tage. Telemetrie ist kein Repository-Nachweis.", "telemetry.table_label":"Tägliche Execution-Host-Telemetrie", "telemetry.day":"Tag", "telemetry.prompts":"Prompts", "telemetry.average_execution":"Durchschn. Ausführung", "telemetry.average_total":"Durchschn. Gesamt", "telemetry.average_wait":"Durchschn. Wartezeit", "telemetry.input":"Eingabe", "telemetry.output":"Ausgabe", "telemetry.total":"Gesamt", "telemetry.complete":"Abgeschlossen", "telemetry.blocked":"Blockiert", "telemetry.failed":"Fehlgeschlagen", "telemetry.empty":"Noch keine abgeschlossene Execution-Host-Telemetrie verfügbar.",
  "value.none":"Keine", "value.no_diagnostics":"Keine Diagnose",
  "technical.pull_requests":"Pull Requests", "technical.implementation":"Implementierung", "technical.finalization":"Abschluss", "technical.repository":"Repository", "technical.repository_status":"Repositorystatus", "technical.workspace_status":"Arbeitsbereichsstatus", "technical.host_preflight":"Host-Vorprüfung", "technical.execution_host":"Execution Host", "technical.execution_host_version":"Version des Execution Host", "technical.runtime":"Laufzeit", "technical.runtime_prompt_transport":"Prompt-Transport der Laufzeit", "technical.host_status":"Hoststatus", "technical.last_check":"Letzte Prüfung", "technical.last_workspace_check":"Letzte Arbeitsbereichsprüfung", "technical.capability_status":"Fähigkeitsstatus", "technical.recoverability":"Wiederherstellbarkeit", "technical.failure_origin":"Fehlerursprung", "technical.recommended_action":"Empfohlene Aktion", "technical.diagnostics":"Diagnose",
  "section.active_prompt":"Aktiver Prompt", "section.inbox_queue":"Inbox-Warteschlange", "section.prompt_history":"Prompt-Verlauf", "section.remaining_usage":"Verbleibende Nutzung", "section.platform_components":"Plattformkomponenten", "section.technical_details":"Technische Details", "section.workspace":"Arbeitsbereich", "section.logs":"Protokolle", "section.execution_host_telemetry":"Execution-Host-Telemetrie", "section.local_ai_processes":"Lokale KI-Prozesse", "section.ai_provider_usage":"KI-Anbieternutzung", "section.ai_execution_diagnostics":"KI-Ausführungsdiagnose", "section.ai_provider_limits":"KI-Anbieterlimits", "section.ai_conversation":"KI-Gespräch", "section.new_ai_question":"Neue Frage an den KI-Assistenten", "chat.user":"Sie", "chat.assistant":"KI-Assistent",
  "description.active_prompt":"Der aktive Engineering-Prompt mit aktuellem Fortschritt, Ausführungszeit und Ausführungskontext.", "description.inbox_queue":"Prompts werden in der Reihenfolge ihres Erstellungsdatums ausgeführt.", "description.prompt_history":"Alle terminalen Engineering-Platform-Ausführungen, lokal im Engineering-SQLite-Speicher zwischengespeichert.", "description.remaining_usage":"Verfügbare Nutzungskapazität und Resets für den aktiven KI-Anbieter.", "description.platform_components":"Live-Gesundheitsprüfung der lokalen Engineering-Platform-Komponenten.", "description.technical_details":"Betriebsdetails zu Pull Requests, Repository, Arbeitsbereich und Diagnose.", "description.workspace":"Der aktive Arbeitsbereich dieses Projekts.", "description.logs":"Bereinigte, rotierende Protokolle von Watcher und Dashboard. Automatisch per Server-Push aktualisiert.",
});
Object.assign(messages.fr, {
  "telemetry.title":"Télémétrie de l’hôte d’exécution", "telemetry.description":"Tendances opérationnelles des sept derniers jours. La télémétrie n’est pas une preuve de dépôt.", "telemetry.table_label":"Télémétrie quotidienne de l’hôte d’exécution", "telemetry.day":"Jour", "telemetry.prompts":"Prompts", "telemetry.average_execution":"Exécution moy.", "telemetry.average_total":"Total moy.", "telemetry.average_wait":"Attente moy.", "telemetry.input":"Entrée", "telemetry.output":"Sortie", "telemetry.total":"Total", "telemetry.complete":"Terminé", "telemetry.blocked":"Bloqué", "telemetry.failed":"Échec", "telemetry.empty":"Aucune télémétrie d’hôte d’exécution terminée n’est encore disponible.",
  "value.none":"Aucun", "value.no_diagnostics":"Aucun diagnostic",
  "technical.pull_requests":"Pull requests", "technical.implementation":"Implémentation", "technical.finalization":"Finalisation", "technical.repository":"Dépôt", "technical.repository_status":"État du dépôt", "technical.workspace_status":"État de l’espace de travail", "technical.host_preflight":"Précontrôle de l’hôte", "technical.execution_host":"Hôte d’exécution", "technical.execution_host_version":"Version de l’hôte d’exécution", "technical.runtime":"Environnement d’exécution", "technical.runtime_prompt_transport":"Transport de prompt d’exécution", "technical.host_status":"État de l’hôte", "technical.last_check":"Dernière vérification", "technical.last_workspace_check":"Dernière vérification de l’espace de travail", "technical.capability_status":"État des capacités", "technical.recoverability":"Récupérabilité", "technical.failure_origin":"Origine de l’échec", "technical.recommended_action":"Action recommandée", "technical.diagnostics":"Diagnostic",
  "section.active_prompt":"Prompt actif", "section.inbox_queue":"File de réception", "section.prompt_history":"Historique des prompts", "section.remaining_usage":"Utilisation restante", "section.platform_components":"Composants de la plateforme", "section.technical_details":"Détails techniques", "section.workspace":"Espace de travail", "section.logs":"Journaux", "section.execution_host_telemetry":"Télémétrie de l’hôte d’exécution", "section.local_ai_processes":"Processus IA locaux", "section.ai_provider_usage":"Utilisation du fournisseur IA", "section.ai_execution_diagnostics":"Diagnostic d’exécution IA", "section.ai_provider_limits":"Limites du fournisseur IA", "section.ai_conversation":"Conversation IA", "section.new_ai_question":"Nouvelle question à l’assistant IA", "chat.user":"Vous", "chat.assistant":"Assistant IA",
  "description.active_prompt":"Le prompt d’ingénierie actif, avec la progression, la durée et le contexte d’exécution actuels.", "description.inbox_queue":"Les prompts sont exécutés dans l’ordre de leur date de création.", "description.prompt_history":"Toutes les exécutions terminales de l’Engineering Platform, mises en cache localement dans le stockage SQLite Engineering.", "description.remaining_usage":"Capacité d’utilisation disponible et réinitialisations du fournisseur IA actif.", "description.platform_components":"Contrôle de santé en direct des composants locaux de l’Engineering Platform.", "description.technical_details":"Détails opérationnels sur les pull requests, le dépôt, l’espace de travail et le diagnostic.", "description.workspace":"L’espace de travail actif de ce projet.", "description.logs":"Journaux filtrés et rotatifs du surveillant et du tableau de bord. Mis à jour automatiquement par push serveur.",
});
Object.assign(messages.es, {
  "telemetry.title":"Telemetría del host de ejecución", "telemetry.description":"Tendencias operativas de los últimos siete días. La telemetría no es evidencia del repositorio.", "telemetry.table_label":"Telemetría diaria del host de ejecución", "telemetry.day":"Día", "telemetry.prompts":"Prompts", "telemetry.average_execution":"Ejecución prom.", "telemetry.average_total":"Total prom.", "telemetry.average_wait":"Espera prom.", "telemetry.input":"Entrada", "telemetry.output":"Salida", "telemetry.total":"Total", "telemetry.complete":"Completado", "telemetry.blocked":"Bloqueado", "telemetry.failed":"Fallido", "telemetry.empty":"Aún no hay telemetría completada del host de ejecución disponible.",
  "value.none":"Ninguno", "value.no_diagnostics":"Sin diagnóstico",
  "technical.pull_requests":"Solicitudes de extracción", "technical.implementation":"Implementación", "technical.finalization":"Finalización", "technical.repository":"Repositorio", "technical.repository_status":"Estado del repositorio", "technical.workspace_status":"Estado del espacio de trabajo", "technical.host_preflight":"Comprobación previa del host", "technical.execution_host":"Host de ejecución", "technical.execution_host_version":"Versión del host de ejecución", "technical.runtime":"Entorno de ejecución", "technical.runtime_prompt_transport":"Transporte de prompts de ejecución", "technical.host_status":"Estado del host", "technical.last_check":"Última comprobación", "technical.last_workspace_check":"Última comprobación del espacio de trabajo", "technical.capability_status":"Estado de capacidades", "technical.recoverability":"Recuperabilidad", "technical.failure_origin":"Origen del fallo", "technical.recommended_action":"Acción recomendada", "technical.diagnostics":"Diagnóstico",
  "section.active_prompt":"Prompt activo", "section.inbox_queue":"Cola de entrada", "section.prompt_history":"Historial de prompts", "section.remaining_usage":"Uso restante", "section.platform_components":"Componentes de la plataforma", "section.technical_details":"Detalles técnicos", "section.workspace":"Espacio de trabajo", "section.logs":"Registros", "section.execution_host_telemetry":"Telemetría del host de ejecución", "section.local_ai_processes":"Procesos de IA locales", "section.ai_provider_usage":"Uso del proveedor de IA", "section.ai_execution_diagnostics":"Diagnóstico de ejecución de IA", "section.ai_provider_limits":"Límites del proveedor de IA", "section.ai_conversation":"Conversación con IA", "section.new_ai_question":"Nueva pregunta para el asistente de IA", "chat.user":"Tú", "chat.assistant":"Asistente de IA",
  "description.active_prompt":"El prompt de ingeniería activo, con el progreso, el tiempo y el contexto de ejecución actuales.", "description.inbox_queue":"Los prompts se ejecutan por orden de fecha de creación.", "description.prompt_history":"Todas las ejecuciones terminales de Engineering Platform, almacenadas localmente en SQLite Engineering.", "description.remaining_usage":"Capacidad de uso disponible y restablecimientos del proveedor de IA activo.", "description.platform_components":"Comprobación de estado en vivo de los componentes locales de Engineering Platform.", "description.technical_details":"Detalles operativos sobre pull requests, repositorio, espacio de trabajo y diagnóstico.", "description.workspace":"El espacio de trabajo activo de este proyecto.", "description.logs":"Registros depurados y rotativos del monitor y el panel. Se actualizan automáticamente mediante envío del servidor.",
});
