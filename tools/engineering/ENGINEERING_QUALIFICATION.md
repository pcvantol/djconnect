...
| Local Engineering Evidence Storage | iCloud Inbox transport and a claimed transaction | prompt archive, status, reports and logs remain under `.engineering/`; iCloud retains only Inbox transport | local qualification report | Registered |
