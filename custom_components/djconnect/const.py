...
API_ASK_DJ_HISTORY_EXPORT = f"{API_ASK_DJ_HISTORY}/export"
API_ASK_DJ_CLEAR = f"{API_ASK_DJ}/clear"
API_ASK_DJ_HISTORY_STATE = f"{API_ASK_DJ}/history_state"
API_MUSIC_DNA = f"{API_BASE}/music_dna"
API_MUSIC_DNA_PROFILE = f"{API_MUSIC_DNA}/profile"
API_MUSIC_DNA_SETTINGS = f"{API_MUSIC_DNA}/settings"
API_MUSIC_DNA_CLEAR = f"{API_MUSIC_DNA}/clear"
API_MUSIC_DNA_EXPORT = f"{API_MUSIC_DNA}/export"
API_MUSIC_DNA_IMPORT = f"{API_MUSIC_DNA}/import"
...
API_SESSION = f"{API_BASE}/session"
API_SESSION_START = f"{API_SESSION}/start"
API_SESSION_END = f"{API_SESSION}/end"
API_SESSION_ACTIVE = f"{API_SESSION}/active"
API_SESSION_BROADCAST = f"{API_SESSION}/broadcast/{{session_id}}"
API_SESSION_BROADCAST_TOKEN = f"{API_SESSION}/broadcast/token"
API_SESSION_BROADCAST_WS = f"{API_SESSION}/broadcast/ws/{{session_id}}"
UNIVERSAL_RECEIVER_PATH = "/djconnect/receiver"
VIBECAST_RENDERER_PATH = "/djconnect/vibecast"
API_IMAGE_PROXY_BASE = f"{API_BASE}/image_proxy"
API_IMAGE_PROXY = f"{API_IMAGE_PROXY_BASE}/{{token}}"
API_PUSH_BOOTSTRAP = f"{API_BASE}/push/bootstrap"
...
CONF_PAIRING_URI = "pairing_uri"
CONF_MUSIC_BACKEND = "music_backend"
CONF_MUSIC_ASSISTANT_PLAYER = "music_assistant_player"
CONF_MUSIC_BACKEND_REVISION = "music_backend_revision"
...
REMOTE_CAPABLE_CLIENT_TYPES = [
    CLIENT_TYPE_IOS,
    CLIENT_TYPE_MACOS,
    CLIENT_TYPE_WINDOWS,
]
LOCAL_DEVICE_CLIENT_TYPES = [
    CLIENT_TYPE_ESP32,
    CLIENT_TYPE_RASPBERRY_PI,
]
CLIENT_TYPE_NAMES = {
    ...
    CLIENT_TYPE_WINDOWS: "Windows app",
    CLIENT_TYPE_ESP32: "ESP32 device",
}
SETUP_METHOD_PAIR_EXISTING = "pair_existing"
SETUP_METHOD_PAIR_LOCAL_DEVICE = "pair_local_device"
SETUP_METHOD_PAIR_APP = "pair_app"
...
MUSIC_BACKEND_NAMES = {
    ...
    MUSIC_BACKEND_MUSIC_ASSISTANT: "Music Assistant",
}
...
VOICE_PROFILE_CLASSIC_RADIO = "classic_radio"
VOICE_PROFILE_LATE_NIGHT = "late_night"
VOICE_PROFILE_ENERGY = "energy"
VOICE_PROFILE_CLEAN_HOST = "clean_host"
DEFAULT_VOICE_PROFILE = VOICE_PROFILE_CLASSIC_RADIO
VOICE_PROFILES = [
