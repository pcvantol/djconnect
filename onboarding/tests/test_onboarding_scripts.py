...
class DevOnboardingScriptTests(unittest.TestCase):
    ...
    def test_macos_host_bootstrap_has_no_token_argument(self) -> None:
        ...
        self.assertIn("onboarding.package_version: 4.3.0", desired_state)
    ...
    def test_macos_host_bootstrap_reports_its_semantic_version(self) -> None:
        ...
        self.assertEqual(
            result.stdout,
            "DJConnect macOS Development Host Bootstrap 2.0.14\n",
        )
...
""",
    ...
    def test_macos_host_bootstrap_uses_a_thin_packaged_entry_point(self) -> None:
        ...
        self.assertIn("package.version: 2.0.14", manifest)
        ...
        self.assertIn("component.operations.version: 1.3.6", manifest)
        ...
        self.assertIn("require_canonical_onboarding_4_3_0", source)
        self.assertIn("requires onboarding 4.3.0", source)
