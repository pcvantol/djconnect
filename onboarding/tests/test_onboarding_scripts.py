...
class DevOnboardingScriptTests(unittest.TestCase):
    ...
    def test_macos_host_bootstrap_has_no_token_argument(self) -> None:
        ...
        self.assertIn("tooling.refresh_casks: docker,dotnet-sdk,parallels,ngrok", desired_state)
    ...
    def test_macos_host_bootstrap_reports_its_semantic_version(self) -> None:
        ...
        self.assertEqual(
            result.stdout,
            "DJConnect macOS Development Host Bootstrap 2.0.5\n",
        )
...
""",
    ...
    def test_macos_host_bootstrap_uses_a_thin_packaged_entry_point(self) -> None:
        ...
        self.assertIn("package.version: 2.0.5", manifest)
        ...
        self.assertIn("component.operations.version: 1.3.1", manifest)
