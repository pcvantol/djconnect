...
- Ask DJ Track Insight-vragen zoals `Geef Track Insight voor dit nummer`, `Analyseer dit nummer`, `Tell me about this track`, `What is special about this song?` en `What is the vibe of this track?` gebruiken het gedeelde `track_insight` contract met `track_insight{track,analysis,music_dna,visual_profile,cache}`, geen apart technical-analysis pad.
