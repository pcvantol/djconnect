...
| CMB-09 | Assess Voice Interaction Host and constrained ESP32 profiles | Assessed | `docs/product/VOICE_INTERACTION_HOST_ESP32_CAPABILITY_PROFILE_ASSESSMENT.md`; HA Voice, Session Start Request and ESP32 appliance-contract evidence | `GO_CMB09_VOICE_PROFILE_QUALIFIED`; voice-first bounded appliance profile, with no Session ownership, direct host coordination or implementation authorization |
